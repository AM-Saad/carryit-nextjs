...
const UploadDocsInput: React.FC<Props> = ({ onSelect }) => {
    ...
    return (
        <div
            className='border-2 border-dashed mb-7 text-center rounded-lg h-32 transition-all duration-300 ease-in-out mt-2
            ...
            <div className='h-full w-full'>
                <label
                    ...
                    <div className='h-full w-full m-auto p-5'>
                        ...
                        <h3>Upload Documents <span className='text-xs block'>e.g. docx, pdf, images</span></h3>
                    </div>
                    <input
                        ref={input}
                        id="documents_input"
