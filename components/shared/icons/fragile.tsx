export default function Fragile({ className }: { className?: string }) {
    return (
        ...
        <svg
            ...
            <path
                id="fragile_1_"
                d="M21,31.36H11v-0.72h4.64V17.35c-3.34-0.187-6-2.963-6-6.35V1c0-0.199,0.161-0.36,0.36-0.36h10
