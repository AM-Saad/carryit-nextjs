...
Command: npx gltfjsx@6.2.10 tabletl.glb 
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/3d/tabletl.glb')
  ...
  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={100}>
        ...
        <mesh geometry={nodes.iPad_Pro_2020_screen_0.geometry} material={new MeshStandardMaterial({color:'green'})} />
...
useGLTF.preload('/3d/tabletl.glb')
